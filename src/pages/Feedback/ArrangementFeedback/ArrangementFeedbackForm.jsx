...
const [feedback, setFeedback] = useState();
  ...
  const onCreate = async (e) => {
    ...
    checkErrors();
    if (noEmptyFields()) {
      await FeedbackService.createArrangementFeedback(token, arrangementId, userId, feedback).then(
...
export default ArrangementFeedbackForm;
